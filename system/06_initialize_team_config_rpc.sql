-- Function to allow 'admin'/'owner'/'manager' to initialize team defaults with Custom Configuration
-- Payload format:
-- {
--   "statuses": [{ "name": "...", "category": "...", "sort_order": 0 }, ...],
--   "sizes": [{ "name": "...", "xp_points": 10, "sort_order": 0 }, ...],
--   "urgencies": [{ "name": "...", "weight": 10, "color": "blue" }, ...]
-- }
...
begin
  ...
  -- Currently we force defaults: Not Started, Started, Achieved, Abandoned
