-- Function to initialize team defaults (Statuses, Sizes, Urgencies)
...
begin
  ...
  -- 2. Verify Permission (Must be Owner or Manager of the target team)
  ...
  if user_role is null or user_role not in ('owner', 'manager') then
    raise exception 'Access Denied: You must be an Owner or Manager to initialize this team.';
  end if;
